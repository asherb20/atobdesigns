...
const IndexPage: React.FC<PageProps> = () => {
  return (
    <div>
      ...
      {/* Hero */}
      <div>
        <div className='pt-5 pr-2 pb-5 pl-2 med-d-flex'>
      ...
      <main>
        <div>
          ...
          <div className='pl-2 pr-2'>
            <ul className='lst-none med-d-flex med-flex-wrap med-col-gap-1'>
              {SERVICES_LINKS.map((link, index) => (
                <li key={index} className='mb-1 med-flex-50'>
        ...
        <div>
          <section className='pt-5 pr-2 pb-5 pl-2'>
            <div>
              <div className='pb-2'>
                <h3 className='fs-28 pb-1'>
          ...
          <div className='bg-dark pt-5 pr-2 pb-3 pl-2 c-white'>
            <div className='pb-2'>
              <h3 className='fs-28 pb-1'>Search Engine Visibility</h3>
              <p className='fs-18'>
                <strong>Beyond Aesthetics:</strong> Benefit from the expertise of a team passionate about staying ahead in the ever-evolving digital landscape. A to B Designs
                brings together seasoned professionals dedicated to delivering excellence.
              </p>
            </div>
        ...
        <div className='pt-5 pr-2 pb-5 pl-2'>
          <section className='pb-2'>
            ...
            <p className='fs-18 pb-1'>
              <strong>Your Vision, Our Mission:</strong> We believe in collaboration. Your vision is the driving force behind everything we do. A to B Designs involves you in
              every step of the process, ensuring your digital journey aligns seamlessly with your business goals.
            </p>
            <p className='fs-18'>
