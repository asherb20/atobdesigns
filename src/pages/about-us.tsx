...
import { ArrowRightIcon, CaretUpIcon, CaretDownIcon } from '../lib/icons';
    ...
    <div>
      ...
      <div>
        <section className='pt-5 pb-5'>
          ...
          <div>
            <div className='p-2 bg-dark c-white'>
      ...
      <div>
        <section className='pb-5'>
          ...
          {SERVICES_LINKS.map((link, ind) => (
            <Link to={link.to} key={ind} className='p-2 m-2 bg-light c-white d-block td-none'>
